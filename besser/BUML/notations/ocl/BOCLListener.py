...
class BOCLListener(ParseTreeListener):
    ...
    def enterFunctionCall(self, ctx: BOCLParser.FunctionCallContext):
        ...
        op_exp.set_referred_operation(self.rootHandler.create_operation_call_exp('FunctionCall'))
    ...
    def enterType(self, ctx: BOCLParser.TypeContext):
        ...
        if isinstance(self.types_of[-1].get_referred_operation(), OperationCallExpression):
            if self.types_of[-1].get_referred_operation().name == "FunctionCall":
                self.types_of.pop()
    ...
    def enterOCLISTYPEOF(self, ctx: BOCLParser.OCLISTYPEOFContext):
        ...
        if self.debug:
            ...
            if self.debug_print:
                print(ctx.getText())
        op_exp = self.rootHandler.create_operation_call_exp("")
        op_exp.set_referred_operation(self.rootHandler.create_operation_call_exp('OCLISTYPEOF'))
        self.types_of.append(op_exp)
        pass
    ...
    def enterOCLASTYPE(self, ctx: BOCLParser.OCLASTYPEContext):
        ...
        if self.debug:
            ...
            if self.debug_print:
                print(ctx.getText())
        op_exp = self.rootHandler.create_operation_call_exp("")
        op_exp.set_referred_operation(self.rootHandler.create_operation_call_exp('OCLASTYPE'))
        self.types_of.append(op_exp)
    ...
    def enterOCLISKINDOF(self, ctx: BOCLParser.OCLISKINDOFContext):
        ...
        if self.debug:
            ...
            if self.debug_print:
                print(ctx.getText())
        op_exp = self.rootHandler.create_operation_call_exp("")
        op_exp.set_referred_operation(self.rootHandler.create_operation_call_exp('OCLISKINDOF'))
        self.types_of.append(op_exp)
